...
export default function ProductCard({ product, index = 0 }) {
        ...
        <div className="relative aspect-square bg-neutral-50 rounded-lg overflow-hidden mb-4">
          ...
          >
            <Heart
              className={`w-4 h-4 transition-colors ${
                isLiked ? "fill-orange-500 text-orange-500" : "text-neutral-600"
              }`}
            />
          </motion.button>
          ...
          {product?.is_new ? (
            <div className="absolute bottom-3 left-3 z-10">
              <span className="px-2 py-1 bg-orange-500 text-white text-[10px] tracking-wider font-medium">
                NEW
              </span>
            </div>
          ) : null}
  ...
  className="w-full py-3 bg-orange-500/95 backdrop-blur-sm text-white text-xs tracking-wider flex items-center justify-center gap-2 hover:bg-orange-600 transition-colors"
>
  ...
  QUICK ADD
      ...
      <div className="text-center">
        ...
        <div className="flex items-center justify-center gap-2">
          ...
          {onSale ? (
            <span className="text-[10px] tracking-wider text-orange-600">SALE</span>
          ) : null}
        </div>
      </div>
    </motion.div>
